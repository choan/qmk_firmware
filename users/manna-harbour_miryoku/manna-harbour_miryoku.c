...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT_miryoku(
    ...
    LT(BUTTON, KC_Z),  ALGR_T(KC_X),      KC_C,              KC_V,              KC_B,              KC_N,              KC_M,              KC_COMM,           ALGR_T(KC_DOT),    LT(BUTTON, KC_SLSH),
    U_NP,              U_NP,              LT(MEDIA, KC_MINS), LT(NAV, KC_SPC),   LT(MOUSE, KC_TAB), LT(SYM, KC_ENT),   LT(NUM, KC_BSPC),  LT(FUN, KC_DEL),   U_NP,              U_NP
  #elif defined MIRYOKU_ALPHAS_QWERTZ
    KC_Q,              KC_W,              KC_E,              KC_R,              KC_T,              KC_Z,              KC_U,              KC_I,              KC_O,              KC_P,
    LGUI_T(KC_A),      LALT_T(KC_S),      LCTL_T(KC_D),      LSFT_T(KC_F),      KC_G,              KC_H,              LSFT_T(KC_J),      LCTL_T(KC_K),      LALT_T(KC_L),      LGUI_T(KC_QUOT),
    LT(BUTTON, KC_Y),  ALGR_T(KC_X),      KC_C,              KC_V,              KC_B,              KC_N,              KC_M,              KC_COMM,           ALGR_T(KC_DOT),    LT(BUTTON, KC_SLSH),
  ...
  [SYM] = LAYOUT_miryoku(
	  KC_ESC, KC_PLUS, KC_EQL,  KC_PERC, KC_HASH, KC_QUES, KC_RBRC, KC_LBRC, KC_AMPR, KC_CIRC,
	  KC_SCLN,   KC_SLSH, KC_LPRN, KC_RPRN, KC_GRV,  KC_MINS, KC_RCBR, KC_LCBR, KC_BSLS, KC_AT,
	  KC_COLN, KC_ASTR, KC_DLR,  KC_EXLM, KC_PIPE, KC_TILD, KC_UNDS, KC_TRNS, KC_TRNS, KC_TRNS,
